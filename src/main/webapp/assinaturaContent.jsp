      ...
      <div class="assinatura-right">
        <div class="benefits-container">
          <ul class="assinatura-benefits">
            <li>- Seleção Especializada: Todos os meses, você recebe vinhos escolhidos por sommeliers experientes.</li>
            <li>- Experiência Enriquecedora: Cada garrafa vem com notas de degustação, harmonizações recomendadas e curiosidades.</li>
            <li>- Exploração de Diferentes Terroirs: Viaje pelo mundo do vinho sem sair de casa.</li>
            <li>- Custo-benefício excepcional: Acesso a vinhos selecionados com condições especiais, garantindo qualidade e exclusividade.</li>
          </ul>
        </div>
      </div>
    </div>
